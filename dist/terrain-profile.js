...
var ascendingBisect = d3Bisector(ascending);
...
function d3Zoom() {
  ...
  function mousedowned() {
    ...
    function mousemoved() {
      ...
      g.zoom("mouse", constrain(translate(g.that.__zoom, g.mouse[0] = d3Mouse(g.that), g.mouse[1]), g.extent, translateExtent));
    }
  ...
  getSVG(parameters = {}) {
    ...
    const chartMargins = {
      ...
      handleMouseMove = target => {
        let transform = transform$1(target),
